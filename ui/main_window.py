...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.gridLayout.addWidget(self.comboBox_board_pattern, 17, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.lineEdit_gens_per_sec, 14, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.lineEdit_cell_size, 16, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.label_current_status, 11, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.pushButton_clear_tail, 18, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.checkBox_trace_1_gen, 19, 0, 1, 2)
        ...
        self.gridLayout.addWidget(self.checkBox_show_tail, 18, 0, 1, 1)
        ...
        self.gridLayout.addWidget(self.lineEdit_surface_width, 9, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.lineEdit_surface_height, 10, 1, 1, 1)
        ...
        sizePolicy4.setHeightForWidth(self.pushButton_clean_surface.sizePolicy().hasHeightForWidth())
        self.pushButton_clean_surface.setSizePolicy(sizePolicy4)
        ...
        self.gridLayout.addWidget(self.checkBox_show_grid, 20, 0, 1, 2)
        ...
        self.gridLayout.addWidget(self.lineEdit_random_ratio, 15, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.label_show_gens, 13, 1, 1, 1)
        ...
        self.comboBox_core_calc = QComboBox(self.horizontalLayoutWidget_2)
        self.comboBox_core_calc.setObjectName(u"comboBox_core_calc")

        self.gridLayout.addWidget(self.comboBox_core_calc, 8, 1, 1, 1)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_10.setText(QCoreApplication.translate("MainWindow", u"Core calc", None))
    # retranslateUi
